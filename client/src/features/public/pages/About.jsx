  ...
  return (
    <div className="bg-surface-base min-h-screen py-16">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-surface-base p-8 md:p-12 rounded-2xl shadow-sm border border-black/5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12 border-t border-text-inverse/10 pt-8">
            <div className="flex items-start">
              <div className="bg-surface-muted/10 p-4 rounded-2xl mr-4">
            ...
            <div className="flex items-start">
              <div className="bg-surface-strong/10 p-4 rounded-2xl mr-4">
